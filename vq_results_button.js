...
function call_check_click(check_name, show_slow_preset_only, show_no_10bit, show_latest_gpu_only, checked, update_chart) {
    ...
    check_click(chart_t1_20221225_bitrate_ssim_data,     target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t1_20221225_bitrate_vmaf_data,     target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t1_20221225_bitrate_fps_data,      target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t1_20221225_vbr_bitrate_ssim_data, target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t1_20221225_vbr_bitrate_vmaf_data, target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t1_20221225_vbr_bitrate_fps_data,  target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t2_20221225_bitrate_ssim_data,     target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t2_20221225_bitrate_vmaf_data,     target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t2_20221225_bitrate_fps_data,      target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t2_20221225_vbr_bitrate_ssim_data, target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t2_20221225_vbr_bitrate_vmaf_data, target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
    check_click(chart_t2_20221225_vbr_bitrate_fps_data,  target_list, enabled_presets, show_no_10bit, enabled_devices_gpu, checked, update_chart);
...
window.onload = function() {
  ...
  chart_t1_20221225_bitrate_ssim_data.update('none');
  chart_t1_20221225_bitrate_vmaf_data.update('none');
  chart_t1_20221225_bitrate_fps_data.update('none');
  chart_t1_20221225_vbr_bitrate_ssim_data.update('none');
  chart_t1_20221225_vbr_bitrate_vmaf_data.update('none');
  chart_t1_20221225_vbr_bitrate_fps_data.update('none');
  chart_t2_20221225_bitrate_ssim_data.update('none');
  chart_t2_20221225_bitrate_vmaf_data.update('none');
  chart_t2_20221225_bitrate_fps_data.update('none');
  chart_t2_20221225_vbr_bitrate_ssim_data.update('none');
  chart_t2_20221225_vbr_bitrate_vmaf_data.update('none');
  chart_t2_20221225_vbr_bitrate_fps_data.update('none');
};